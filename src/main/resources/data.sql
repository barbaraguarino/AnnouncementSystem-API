...
values
    ...
    ('c5cf3a0c-4e07-4c80-9ec4-8e69a1980a96', 'Estágio em Engenharia Civil', 'Oportunidade de estágio para estudantes de Engenharia Civil. Atuação em obras e planejamento, com possibilidade de aprendizado prático no setor.', 0, 'julia.medeiros@id.uff.br', 'a8648c4c-7a31-4c79-bebe-ab5ca149e0f4','2024-10-21 11:45:00', '0', 'estagio-civil'),
    ('c8e682c8-bbba-429e-b5f3-e743c2e8e3c7', 'Oficina de Criatividade e Inovação', 'Desperte sua criatividade em nossa oficina interativa. Atividades práticas e dinâmicas para estimular a inovação.', 120.0, 'tatiana.costa@id.uff.br', 'a8648c4c-7a31-4c79-bebe-ab5ca149e0f4','2024-12-14 14:04:00', '0', 'oficina-criatividade'),
    ('4f203eb3-d01d-4dd0-b711-7ec8c35d6d4e', 'Doação de Livros de Literatura', 'Doação de livros de literatura em ótimo estado. Inclui clássicos e contemporâneos. Ótima oportunidade para quem ama ler!', 0, 'arthur.lima@id.uff.br', 'd311ab08-6c59-4f94-aa63-56dbe3ed3251','2024-10-15 18:00:00', '0', 'livros-literatura'),
    ('e94592b6-d63e-4638-836f-cd23cf16e41b', 'Venda de Bicicleta Mountain Bike', 'Bicicleta mountain bike em ótimo estado, ideal para trilhas e passeios. Vendo por motivo de mudança. Acompanha acessórios como capacete e suporte para garrafa.', 0, 'arthur.lima@id.uff.br', 'd311ab08-6c59-4f94-aa63-56dbe3ed3251','2024-08-06 22:25:00', '0', 'bike'),
    ('f94f7315-4ff4-4ae6-8e7a-2b6e06cc2858', 'Venda de Livro de Programação', 'Vendo livro ''Introdução à Programação em Java''. Material novíssimo, utilizado apenas uma vez. Excelente para quem quer aprender a programar.', 0, 'luiza.monteiro@id.uff.br', '9bc05733-ceb1-4412-b3dd-13e9e02538ac','2024-11-29 16:15:00', '0', 'livros-programacao'),
    ('f3e9a8c4-1f67-41f8-b3f1-0983f0b4b197', 'Workshop de Fotografia Digital', 'Participe do nosso workshop de fotografia digital e aprenda técnicas para capturar imagens impressionantes. Vagas limitadas!', 150.90, 'luiza.monteiro@id.uff.br', 'a8648c4c-7a31-4c79-bebe-ab5ca149e0f4','2024-11-21 15:39:00', '0', 'workshop-photo'),
...
values
    ...
    ('7f5f7e73-94e6-4bc1-a00b-819b4ef9c171', 'Doação de Roupas Infantis', 'Estou doando roupas infantis em bom estado, tamanho 3 a 6 anos. Se alguém precisar, entre em contato.', 0, 'tatiana.costa@id.uff.br', 'a8648c4c-7a31-4c79-bebe-ab5ca149e0f4','2024-12-18 14:11:00', '0'),
    ...
    ('e4b5d4f2-4ac1-4b43-8b9d-e1b9d8ddefb5', 'Curso de Marketing Digital para Iniciantes', 'Entenda como o marketing digital pode ajudar seu negócio. O curso aborda SEO, redes sociais e campanhas online.', 0, 'luiza.monteiro@id.uff.br', 'a8648c4c-7a31-4c79-bebe-ab5ca149e0f4','2024-09-23 16:47:00', '0'),
    ('c8e682c8-bbba-429e-b5f3-e743c2e8e3c7', 'Oficina de Criatividade e Inovação', 'Desperte sua criatividade em nossa oficina interativa. Atividades práticas e dinâmicas para estimular a inovação.', 120.0, 'tatiana.costa@id.uff.br', 'a8648c4c-7a31-4c79-bebe-ab5ca149e0f4','2024-12-14 14:04:00', '0'),
    ('db1a8f76-5b38-490c-a5c4-8f484d39e9da', 'Curso de Língua Estrangeira: Inglês para Negócios', 'Melhore suas habilidades em inglês com foco em ambientes de negócios. Aulas práticas e conversação.', 450.10, 'tatiana.costa@id.uff.br', 'a8648c4c-7a31-4c79-bebe-ab5ca149e0f4','2024-11-15 12:22:00', '0'),
    ...
    ('be8d2ef2-8914-4fc6-8610-e3cd86e65007', 'Vaga para Designer Gráfico', 'Estamos à procura de um designer gráfico criativo para se juntar à nossa equipe. É desejável ter portfólio e experiência com design digital.', 0, 'dutra.tony@id.uff.br', 'ba66c35c-46b9-4e65-95e0-a6d3c3998991','2024-11-29 12:11:00', '0'),
    ...
    ('f3fbc9bb-4ff3-40fa-a548-8a0f4f84f35e', 'Desenvolvedor Java Sênior', 'Estamos contratando um desenvolvedor Java sênior para trabalhar em projetos desafiadores. É necessário ter experiência em Spring Boot e Microservices.', 0, 'dutra.tony@id.uff.br', '7e3ff6e4-c06a-40ca-99e3-9c9979d5f113','2024-11-5 09:30:00', '0')
ON CONFLICT (id) DO NOTHING;
